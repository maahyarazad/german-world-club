...
export const de = {
  ...
  pushAdmin: {
    pageTitle: 'Push-Benachrichtigungen',
    subtitle: 'Erst an Testnutzer proben, dann an die Telefone aller Mitglieder senden.',
    compose: 'Verfassen',
    testUsers: 'Testnutzer',
    history: 'Verlauf',
    testUsersHint: 'Proben gehen nur an die Telefone dieser Mitglieder.',
    handle: 'Benutzername',
    add: 'Hinzufügen',
    remove: 'Entfernen',
    handleNotFound: 'Kein Mitglied hat diesen Benutzernamen.',
    noTestUsers: 'Noch keine Testnutzer. Fügen Sie vor der Probe einen hinzu.',
    unnamed: 'Ohne Namen',
    oneDevice: '1 Gerät',
    ...
    destination: 'Öffnet',
    destinationId: 'ID',
    destinationSlug: 'Organisations-Slug',
    destinationLabel: 'Bezeichnung (für den Verlauf)',
    destinations: {
      none: 'Nichts (nur die App)',
      offer: 'Ein Angebot',
      listing: 'Eine Marktplatz-Anzeige',
      thread_post: 'Einen Thread-Beitrag',
      event: 'Ein Event',
      partner: 'Ein Partnerprofil',
    },
    sendRehearsal: 'Probe senden',
    broadcast: 'An alle senden…',
    confirmTitle: 'An alle Mitglieder senden?',
    confirmBody: 'Das erreicht {members} Mitglieder auf {devices} Geräten und kann nicht zurückgenommen werden.',
    confirmSend: 'An alle senden',
    cancel: 'Abbrechen',
    rehearsalQueued: 'Probe eingereiht.',
    broadcastQueued: 'Sendung eingereiht.',
    queuedHint: 'Die Zustellung läuft im Hintergrund; verfolgen Sie sie im Verlauf.',
    networkError: 'Der Server war nicht erreichbar. Es ging nichts verloren — erneutes Senden sendet nicht doppelt.',
    noHistory: 'Noch nichts gesendet.',
    notRendered: 'Der Text entsteht beim Senden',
    totals: '{sent} gesendet · {delivered} bestätigt · {failed} fehlgeschlagen · {skipped} übersprungen · {pending} ausstehend',
    kinds: { rehearsal: 'Probe', broadcast: 'Sendung', offer: 'Angebot' },
    statuses: {
