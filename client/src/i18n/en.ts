...
export const en = {
  ...
  memberThreads: {
    tabLabel: 'Threads',
    title: 'Threads',
    subtitle: 'What members are talking about.',
    forYou: 'For you',
    following: 'Following',
    compose: 'New post',
    ...
    posting: 'Posting …',
    cancel: 'Cancel',
    addMedia: 'Photos or videos',
    mediaAlt: 'Description (required)',
    mediaRemove: 'Remove',
    ...
    mediaFailed: 'A photo or video could not be uploaded.',
    empty: 'No posts yet.',
    emptyFollowing: 'Follow members to see their posts here.',
    loadMore: 'Load more',
    loadFailed: 'The posts could not be loaded.',
    retry: 'Try again',
    reply: 'Reply',
    like: 'Like',
    unlike: 'Unlike',
    ...
    reported: 'Thank you — the post has been reported.',
    delete: 'Delete',
    ...
    inReplyTo: 'Replying to',
    quotes: 'Quotes',
    likes: 'Likes',
    back: 'Back',
    influencer: 'Influencer',
    playVideo: 'Play video',
    counts: { replies: 'Replies', likes: 'Likes', reposts: 'Reposts', quotes: 'Quotes' },
  },
  ...
  memberProfile: {
    ...
    displayNameHint: 'Name changes go through a request to the GWC team.',
    save: 'Save',
    saved: 'Saved.',
    handle: 'Username',
    handleChange: 'Change username',
    ...
    mute: 'Mute',
    unmute: 'Unmute',
    blockConfirm: 'Block? You will no longer see each other, and any following ends.',
    privacy: 'Blocked & muted',
    blockedList: 'Blocked members',
    mutedList: 'Muted members',
    noneBlocked: 'Nobody blocked.',
    noneMuted: 'Nobody muted.',
    followersTitle: 'Followers of {name}',
    followingTitle: '{name} follows',
  ...
  organisationProfile: {
    ...
    intro: 'How members see your organisation.',
    ...
    empty: 'No public profile yet.',
  },

  threadsModeration: {
    title: 'Threads moderation',
    subtitle: 'Review reported posts: hide, restore or remove them.',
    queue: 'Open reports',
    empty: 'No open reports.',
    post: 'Post',
    ...
    states: { visible: 'Visible', hidden: 'Hidden', removed: 'Removed', deleted: 'Deleted by author' },
  },

  pushAdmin: {
    pageTitle: 'Push notifications',
    subtitle: 'Rehearse on test users, then send to every member\'s phone.',
    compose: 'Compose',
    testUsers: 'Test users',
    history: 'History',
    testUsersHint: 'Rehearsals go only to these members\' phones.',
    handle: 'Username',
    add: 'Add',
    remove: 'Remove',
    handleNotFound: 'No member has that username.',
    noTestUsers: 'No test users yet. Add one before rehearsing.',
    unnamed: 'No name',
    oneDevice: '1 device',
    ...
    destination: 'Opens',
    destinationId: 'ID',
    destinationSlug: 'Organisation slug',
    destinationLabel: 'Label (for the history)',
    destinations: {
      none: 'Nothing (just the app)',
      offer: 'An offer',
      listing: 'A marketplace listing',
      thread_post: 'A thread post',
      event: 'An event',
      partner: 'A partner profile',
    },
    sendRehearsal: 'Send rehearsal',
    broadcast: 'Broadcast…',
    confirmTitle: 'Send to every member?',
    confirmBody: 'This reaches {members} members on {devices} devices and cannot be recalled.',
    confirmSend: 'Send to everyone',
    cancel: 'Cancel',
    rehearsalQueued: 'Rehearsal queued.',
    broadcastQueued: 'Broadcast queued.',
    queuedHint: 'Delivery runs in the background; follow it in the history.',
    networkError: 'The server could not be reached. Nothing was lost — sending again will not send twice.',
    noHistory: 'Nothing sent yet.',
    notRendered: 'Text is written when it is sent',
    totals: '{sent} sent · {delivered} confirmed · {failed} failed · {skipped} skipped · {pending} pending',
    kinds: { rehearsal: 'Rehearsal', broadcast: 'Broadcast', offer: 'Offer' },
    statuses: {
  ...
  influencerAdmin: {
    title: 'Members',
    subtitle: 'Grant and revoke influencer status.',
    search: 'Username',
    find: 'Find',
    notFound: 'No member has that username.',
    history: 'History',
    noHistory: 'Never an influencer.',
    active: 'Active',
    revoked: 'Revoked',
    grant: 'Grant influencer status',
    revoke: 'Revoke influencer status',
