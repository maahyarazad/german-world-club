...
import { parseOptions } from '../seed/options.js'
import { createFaker, SEED } from '../seed/faker.js'
import { hashAll } from '../seed/hashing.js'
import { WRITABLE, NEVER_SEEDED } from '../seed/tables.js'
...
try {
  ...
  const counts = {}
  const { seedMembers } = await import('../seed/members.js')
  const { seedStaff } = await import('../seed/staff.js')
  const { seedOrganisations } = await import('../seed/organisations.js')
  const { seedOffers } = await import('../seed/offers.js')
  const { seedEvents } = await import('../seed/events.js')
  const { seedContent } = await import('../seed/content.js')
  const { seedOperations } = await import('../seed/operations.js')
  const { CREDENTIALS, renderCredentials, writeCredentials } = await import('../seed/credentials.js')
