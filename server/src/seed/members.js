import { safeEmail, safeMobile, EMAIL_DOMAIN } from './faker.js'
import { hashFor, LEGACY_MD5_HASH } from './hashing.js'
...
export async function seedMembers(pool, faker, options) {
