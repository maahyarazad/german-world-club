...
// REDIS_ENABLED is deliberately NOT defaulted on. Off, the redis plugin degrades to
...
// second service. Set REDIS_ENABLED=true and REDIS_URL to run the same suites
// against Redis.
